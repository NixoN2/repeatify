                ...
                <div onClick={()=>{setOpen(!open)}}>
                    ...
                    <div className={classnames({"-top-64": !open}, "fixed transition duration-300 ease-in-out top-16 w-48 filter drop-shadow-xl")}>
                        <ul className="flex justify-center items-center flex-col bg-white border border-gray-200">
                            ...
                            <li onClick={clickLink} data-name="/" className="text-carolina-blue text-lg p-2 hover:bg-gray-100 w-full text-center cursor-pointer">Collections</li>
                            <li onClick={(e) => {toggleAuth(); clickLink(e)}} data-name="/" className="text-carolina-blue text-lg p-2 hover:bg-gray-100 w-full text-center cursor-pointer">Exit</li>
                        </ul>
                    </div>
                </div>
            </div>
